...
Price[,heat_type_central := as.numeric(heat_type_central)]
Price[,heat_type_district := as.numeric(heat_type_district)]
Price[,heat_type_individual := as.numeric(heat_type_individual)]
Price[,front_door_structure_corridor := as.numeric(front_door_structure_corridor)]
Price[,front_door_structure_mixed := as.numeric(front_door_structure_mixed)]
Price[,front_door_structure_stairway := as.numeric(front_door_structure_stairway)]
```
